'''
    evaluate physicochmemical properties of peptides
        credit/copy from Hydramp project 
        source:　https://github.com/szczurek-lab/hydramp/blob/master/amp/utils/phys_chem_propterties.py
'''
